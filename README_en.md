...
everai app deploy  
```
After running `everai app list`, you can see the result shown like this.  If your app's status is `STATUS_DEPLOYED`, it means that your app is deployed successfully.   
```bash
